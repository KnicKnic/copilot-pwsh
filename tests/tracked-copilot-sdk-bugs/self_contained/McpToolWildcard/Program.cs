...
// to the session. SessionConfig.AvailableTools is set to a server wildcard
...
var sessionConfig = new SessionConfig
{
    ...
    AvailableTools = new List<string> { wildcard },
