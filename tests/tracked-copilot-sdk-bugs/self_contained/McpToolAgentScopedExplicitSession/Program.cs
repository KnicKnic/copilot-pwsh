...
// prefixed names AND the same names are passed at the session level via
// SessionConfig.AvailableTools. The agent is selected via Rpc.Agent.SelectAsync.
//
...
Console.WriteLine($"Session AvailableTools: [{string.Join(", ", McpHelper.Prefixed)}]\n");
...
var sessionConfig = new SessionConfig
{
    ...
    AvailableTools = new List<string>(McpHelper.Prefixed),
