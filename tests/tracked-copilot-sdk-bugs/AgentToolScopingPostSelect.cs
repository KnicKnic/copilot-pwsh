// ============================================================================
// Bug: CustomAgentConfig.Tools not enforced — Rpc.Agent.SelectAsync post-select
// ============================================================================
//
// Agent is selected AFTER session creation via session.Rpc.Agent.SelectAsync().
// SessionConfig.Agent is NOT set — the agent is chosen post-creation.
...
//
// Run:  dotnet run -- AgentToolScopingPostSelect
// ============================================================================

using GitHub.Copilot.SDK;

public class AgentToolScopingPostSelect : IBugRepro
{
    public bool ExpectsFail => false;
    public string Description =>
        "Rpc.Agent.SelectAsync post-select: agent Tools not enforced, model sees all session tools";
    ...
    public async Task<int> RunAsync(string cliPath)
    {
        ...
        Console.WriteLine("Creating session WITHOUT SessionConfig.Agent...");
        await using var session = await client.CreateSessionAsync(sessionConfig);
        Console.WriteLine("Session created.");
        Console.WriteLine();

        // Select agent post-creation via RPC
