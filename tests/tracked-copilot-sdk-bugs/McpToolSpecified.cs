// ============================================================================
// Test: MCP server with AvailableTools specifying the server
// ============================================================================
//
// Same as McpToolDiscovery but also sets SessionConfig.AvailableTools
// to include "github-mcp-server" (bare server name) to explicitly request
...
public class McpToolSpecified : IBugRepro
{
    ...
    public string Description =>
        "MCP server with AvailableTools = [\"github-mcp-server\"]: tools should be exposed";
    ...
    public async Task<int> RunAsync(string cliPath)
    {
        ...
        Console.WriteLine("Creating session with remote MCP server + AvailableTools...");
